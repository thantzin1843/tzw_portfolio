    ...
    <div className='mt-[50px]'>
            <div className='flex flex-wrap w-full'>
                ...
                <div className='md:w-1/3 sm:w-full '>
                    ...
                    <div className='mt-5'>
                    <CgMail size={35} className='inline'/> &nbsp; thantzinwin1843@gmail.com
                    </div>
                    <div className='mt-5'>
                    <FaGithub size={35} className='inline'/> &nbsp; https://github.com/thantzin1843
                    </div>
                    <div className='mt-5'>
                    <MdOutlinePhone  size={35} className='inline'/> &nbsp; 09-445068826
                    </div>
                    <div className='flex mt-5 gap-2'>
                    <FaLinkedin  size={35} className='inline'/> &nbsp; <div>https://www.linkedin.com/in/thant-zin-win-5570a5242/</div>
                    </div>
                    <div className='mt-5'>
